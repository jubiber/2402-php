...
INSERT INTO employees (emp_no, birth_date, last_name, gender, hire_date)
VALUES(500000, 20000101, 'mee', 'rkat', 'M', DATE(NOW()));
-- 2. 위와 동일
INSERT INTO salaries (emp_no, salary, from_datem tO_date)
VALUES(500000, 30000, DATE(NOW()), 99990101);
INSERT INTO dept_emp (emp_no, title, from_datem tO_date)
VALUES(500000, 'Staff', DATE(NOW()), 99990101);
INSERT INTO dept_emp (emp_no, salary, from_datem tO_date)
VALUES(500000, 'd001', DATE(NOW()), 99990101);
-- 3. 짝궁의 [1,2] 것도 넣어주세요.
INSERT INTO employees (emp_no, birth_date, last_name, gender, hire_date)
VALUES(500000, 20000101, 'c', 'at', 'F', DATE(NOW()))
,(500000, 20000103, 'd', 'og', 'M', DATE(NOW()));
...
INSERT INTO titles (emp_no, title, from_datem tO_date)
VALUES(500000, 'Staff', DATE(NOW()), 99990101)
,(500000, 'Staff', DATE(NOW()), 99990101);

INSERT INTO dept_emp (emp_no, salary, from_datem tO_date)
VALUES(500000, 'd001', DATE(NOW()), 99990101)
,(500000, 'd001', DATE(NOW()), 99990101);
...
;
INSERT INTO dept_emp (emo_no, dept_no, from_date, to_date)
VALUES
...
-- 04
DELETE FROM usere WHERE userid = 1;
